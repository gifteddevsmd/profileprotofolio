...
const { TelegraPh, UploadFileUgu, webp2mp4File, floNime } = require('./lib/daveupload');
...
const { smsg, runtime, fetchUrl, isUrl, processTime, formatp, tanggal, formatDate, getTime,  sleep, generateProfilePicture, clockString, fetchJson, getBuffer, jsonformat, format, parseMention, getRandom } = require('./lib/davefunc');
...
async function handleMessageRevocation(client, revocationMessage) {
  ...
  if (originalMessage) {
    ...
    let notificationText = `░𝙃𝙤𝙡𝙡𝙖...𝙂𝙄𝙁𝙏𝙀𝘿-𝙈𝘿 𝘼𝙉𝙏𝙄𝘿𝙀𝙇𝙀𝙏𝙀░\n\n` +
...
contextInfo: {
          ...
          thumbnailUrl: "https://files.catbox.moe/es52fg.m4a",
          sourceUrl: '',
          mediaType: 1,
...
if (antilinkall === 'TRUE' && body.includes('https://') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, {text:`𝗛𝗲𝘆 @${ki.split("@")[0]}👋\n\n𝗦𝗲𝗻𝗱𝗶𝗻𝗴 𝗟𝗶𝗻𝗸𝘀 𝗶𝘀 𝗣𝗿𝗼𝗵𝗶𝗯𝗶𝘁𝗲𝗱 𝗶𝗻 𝘁𝗵𝗶𝘀 𝗚𝗿𝗼𝘂𝗽 !`, contextInfo:{mentionedJid:[ki]}}, {quoted:m}); 
  ...
  //========================================================================================================================//
    ...
    if (cmd && !m.isGroup) {
      console.log(chalk.dave(chalk.bgWhite("[ 𝐆𝐈𝐅𝐓𝐄𝐃-𝐌𝐃 ]")), color(argsLog, "turquoise"), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
    } else if (cmd && m.isGroup) {
      console.log(
        chalk.dave(chalk.bgWhite("[ LOGS ]")),
...
if (menu === 'VIDEO') {
                   ...
                   client.sendMessage(m.chat, {
                        video: fs.readFileSync('./Media/davey.mp4'),
                        caption: cap,
                        gifPlayback: true
                    }, {
                        quoted: m
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnail: fs.readFileSync('./Media/davemachant.jpg'),
                                sourceUrl: 'https://wa.me/254104260236?text=Hello👋+dave+Nihostie+Bot+Mkuu+😔',
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
                        }
...
m.reply("𝐰𝐚𝐢𝐭 𝐚 𝐦𝐨𝐦𝐞𝐧𝐭 𝐟𝐨𝐫 𝐁𝐥𝐚𝐜𝐤 𝐌𝐃 𝐩𝐚𝐢𝐫 𝐜𝐨𝐝𝐞")
        ...
        let { data } = await axios(`https://davlo-pair.onrender.com/code?number=${number}`);
        let code = data.code;
...
case 'video2': { 
 ...
 await client.sendMessage(
        m.chat,
        {
          ...
          mimetype: "video/mp4",
          caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗚𝗜𝗙𝗧𝗘𝗗-𝗠𝗗",
        },
        { quoted: m }
      );
      return;
        ...
        async function redeployApp() {
            try {
                const response = await axios.post(
                    ...
                    {
                        source_blob: {
                            url: "https://github.com/giftdee/GIFTED-MD/tarball/main",
                        },
                    },
                    {
                        headers: {
                ...
                await m.reply("Your bot is undergoing a ruthless upgrade, hold tight for the next 2 minutes as the redeploy executes! Once done, you’ll have the freshest version of *dave-BOT* unleashed upon you.");
            ...
            .on("end", async () => {
              await client.sendMessage(
                m.chat,
                {
                  ...
                  mimetype: "audio/mp3",
		  caption: "𝔇𝔬𝔴𝔫𝔩𝔬𝔞𝔡𝔢𝔡 𝔟𝔶>>>𝙂𝙄𝙁𝙏𝙀𝘿-𝙈𝘿 𝐁𝐎𝐓",
...
//========================================================================================================================//		      
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `downloaded by>>>𝙂𝙄𝙁𝙏𝙀𝘿-𝙈𝘿`
    });
  } catch (_0x180d0734) {
    m.reply(_0x180d0734);
  }
...
//========================================================================================================================//		      
	      case 'impressive': {
		      var mumaker = require("mumaker");
		     if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "impressive daveY");
      return;
    }
     try {
...
//========================================================================================================================//		      
		...
		var mumaker = require("mumaker");
		     if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Neon davey");
      return;
    }
     try {
...
//========================================================================================================================//		      
	      case 'devil':{
		      var mumaker = require("mumaker");
		          if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Devil davey");
      return;
    }
     try {
...
//========================================================================================================================//		      
		 ...
		 var mumaker = require("mumaker");
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "purple davey");
      return;
    }
     try {
...
//========================================================================================================================//		      
	case 'leaves': {
		     var mumaker = require("mumaker"); 
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Leaves daveMARCHANT-BOT");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case '1917': {
		     var mumaker = require("mumaker"); 
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "1917 dave-merchant");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case 'arena': {
		     var mumaker = require("mumaker"); 
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "arena dave-BOT");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case 'hacker': {
		      var mumaker = require("mumaker");
		      if (!text || text == "") {
    m.reply("Example usage :  " + prefix + "hacker davey");
    return;
  }
  try {
...
//========================================================================================================================//		      
	 ...
	 var mumaker = require("mumaker");
		      if (!text || text == "") {
    m.reply("Example Usage : " + prefix + "sand dave");
    return;
  }
  try {
...
//========================================================================================================================//		      
	...
	var mumaker = require("mumaker");	      
    if (!text || text == "") {
      m.reply("Example usage :  " + prefix + "dragonball dave-merchant");
      return;
    }
      try {
...
//========================================================================================================================//		      
		...
		var mumaker = require("mumaker");      
		      if (!text || text == "") {
      m.reply("Example usage : " + prefix + "naruto davey");
      return;
    }
    try {
...
//========================================================================================================================//		      
	      case 'graffiti': {
		    var mumaker = require("mumaker");  
		      if (!text || text == "") {
    m.reply("Example usage : " + prefix + "graffiti dave-merchant");
    return;
  }
  try {
...
//========================================================================================================================//		      
	      case 'cat': {
		   var mumaker = require("mumaker");
		  if (!text || text == "") { m.reply("Example usage : * " + prefix + "cat davey");
    return;
  }
  try {
...
//========================================================================================================================//		      
	    ...
	    var mumaker = require("mumaker");
		      ...
		      if (!text || text == "") {
    m.reply("Example usage: " + prefix + "Child davey");
    return;
  } 
  try {
...
//========================================================================================================================//
	      case "davey":
		{
        if (!text) return reply(`𝐇𝐞𝐥𝐥𝐨 𝐈'𝐦 𝙂𝙄𝙁𝙏𝙀𝘿-𝙈𝘿 𝐀𝐈. 𝐇𝐨𝐰 𝐜𝐚𝐧 𝐈 𝐡𝐞𝐥𝐩 𝐲𝐨𝐮?`);
...
case "support": {
    ...
    const 𝕭𝖑𝖆𝖈𝖐𝖞 = {
        links: {
            ...
            github: "https://github.com/GIFTED-MD/issues",
            developer: "https://wa.me/254104260236"
        },
        media: {
...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀`.trim();
    ...
    await client.sendMessage(m.chat, {
        ...
        contextInfo: {
            externalAdReply: {
                title: "🅿🆁🅴🅼🅸🆄🅼 🆂🆄🅿🅿🅾🆁🆃",
                body: "daveY BOT v3.0 | Instant Response",
...
//========================================================================================================================//		      
    ...
    if (!args || !args[0]) {
      ...
      setTimeout(() => {
        client.sendMessage(m.chat, {
          text: `𝐆𝐈𝐅𝐓𝐄𝐃-𝐌𝐃 𝘄𝗶𝗹𝗹 𝗻𝗼𝘄 𝗿𝗲𝗺𝗼𝘃𝗲 𝗮𝗹𝗹 ${_0x2f8982.length} 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀 𝗳𝗿𝗼𝗺 𝘁𝗵𝗶𝘀 𝗴𝗿𝗼𝘂𝗽 𝗰𝗵𝗮𝘁 𝗶𝗻 𝘁𝗵𝗲 𝗻𝗲𝘅𝘁 𝘀𝗲𝗰𝗼𝗻𝗱.\n\n𝗚𝗼𝗼𝗱 𝗯𝘆𝗲 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀. 𝗧𝗵𝗶𝘀 𝗽𝗿𝗼𝗰𝗲𝘀𝘀 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗲 𝘁𝗲𝗿𝗺𝗶𝗻𝗮𝘁𝗲𝗱⚠️`
        }, {
          quoted: m
        });
        setTimeout(() => {
...
if (!text) return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 davemachant AI 𝗨𝘀𝗲 𝗚𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
...
let fdr = await client.downloadAndSaveMediaMessage(m.quoted)
                    ...
                    m.reply("𝗔 𝗠𝗼𝗺𝗲𝗻𝘁, 𝐁𝐋𝐀𝐂𝐊𝐌𝐀𝐂𝐇𝐀𝐍𝐓 [𝐆𝐈𝐅𝐓𝐄𝐃-𝐌𝐃-𝗔𝗜] 𝗶𝘀 𝗮𝗻𝗮𝗹𝘆𝘇𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗼𝗻𝘁𝗲𝗻𝘁𝘀 𝗼𝗳 𝘁𝗵𝗲 𝗶𝗺𝗮𝗴𝗲. . .");
...
let fdr = await client.downloadAndSaveMediaMessage(m.quoted)
                    ...
                    m.reply("𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, daveMARCHANT 𝗶𝘀 𝗲𝗿𝗮𝘀𝗶𝗻𝗴 𝘁𝗵𝗲 𝗯𝗮𝗰𝗸𝗴𝗿𝗼𝘂𝗻𝗱. . .");
...
await m.reply('𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, daveY 𝗶𝘀 𝗖𝗼𝗺𝗽𝗶𝗹𝗶𝗻𝗴 '+gcdata.participants.length+' 𝗖𝗼𝗻𝘁𝗮𝗰𝘁𝘀 𝗶𝗻𝘁𝗼 𝗮 𝗩𝗰𝗳...');
...
//========================================================================================================================//		      
 ...
 if (!Owner) throw NotOwner;  
     ...
     let stoy = '*𝗕𝗲𝗹𝗼𝘄 𝗔𝗿𝗲 𝗛𝗲𝗿𝗼𝗸𝘂 𝗩𝗮𝗿𝗶𝗮𝗯𝗹𝗲𝘀 𝗙𝗼𝗿 𝐆𝐈𝐅𝐓𝐄𝐃-𝐌𝐃:*\n\n';  
...
if (users == "254104260236@s.whatsapp.net") return m.reply("It's an Owner Number! 😡");
...
await client.sendMessage(m.chat,{video : {url : twtvid },caption : `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝐆𝐈𝐅𝐓𝐄𝐃-𝐌𝐃`,gifPlayback : false },{quoted : m}) 
...
if (!text) {
    ...
    try {
        ...
        await client.sendMessage(
            ...
            {
                video: { url: fbvid },
                caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝐆𝐈𝐅𝐓𝐄𝐃-𝐌𝐃",
                gifPlayback: false,
            },
            { quoted: m }
        );
...
try {
        ...
        const capp = `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗚𝗜𝗙𝗧𝗘𝗗-𝗠𝗗`;
...
╚══≪ ✦ ≫══════════≪ ✦ ≫══╝\n\n🔷 𝐆𝐢𝐭𝐇𝐮𝐛 𝐑𝐞𝐩𝐨:
   ↳ https://github.com/giftdee/GIFTED-MD
   ★ Don't forget to Fork & Star!.\n\n 🔶 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 𝐏𝐚𝐢𝐫𝐢𝐧𝐠:
   ↳ https://davlo-pair.onrender.com
   ★ Save your Session-ID!\n\n.⚙️ 𝐑𝐞𝐪𝐮𝐢𝐫𝐞𝐦𝐞𝐧𝐭𝐬:
   ✓ Complete all variables
   ✓ Keep API keys secure
   ✓ Deploy properly\n\n╔══≪ ✦ ≫═══════════════≪ ✦ ≫══╗
  Made with ❤️ by davey Dev
...
//========================================================================================================================//		      
          case "leave": { 
                 if (!Owner) throw NotOwner;
		 if (!m.isGroup) throw group;
 await client.sendMessage(m.chat, { text : '𝗚𝗼𝗼𝗱𝗯𝘆𝗲 𝗲𝘃𝗲𝗿𝘆𝗼𝗻𝗲👋. 𝐆𝐈𝐅𝐓𝐄𝐃-𝐌𝐃-𝗔𝗶 𝗶𝘀 𝗟𝗲𝗮𝘃𝗶𝗻𝗴 𝘁𝗵𝗲 𝗚𝗿𝗼𝘂𝗽 𝗻𝗼𝘄...' , mentions: participants.map(a => a.id)}, { quoted : m }); 
...
//========================================================================================================================//		      
     case "hidetag": case "tag": { 
             ...
             if (!isBotAdmin) throw botAdmin; 
             if (!isAdmin) throw admin; 
            client.sendMessage(m.chat, { text : q ? q : 'daveY 𝗕𝗹𝗶𝗻𝗱 𝗧𝗮𝗴𝘀😅' , mentions: participants.map(a => a.id)}, { quoted: m }); 
             } 
 break; 
...
if (!m.quoted) return m.reply("quote a viewonce message eh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      ...
      client.sendMessage(m.chat, { image: { url: imageUrl }, caption: `Retrieved by daveie!\n${imageCaption}`}, { quoted: m });
    }

    if (quotedMessage.videoMessage) {
      let videoCaption = quotedMessage.videoMessage.caption;
      let videoUrl = await client.downloadAndSaveMediaMessage(quotedMessage.videoMessage);
      client.sendMessage(m.chat, { video: { url: videoUrl }, caption: `Retrieved by daveie!\n${videoCaption}`}, { quoted: m });
    }
      }
	break;
...
if (!m.quoted) return m.reply("quote a viewonce message eh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      let imageCaption = quotedMessage.imageMessage.caption;
      let imageUrl = await client.downloadAndSaveMediaMessage(quotedMessage.imageMessage);
      client.sendMessage(client.user.id, { image: { url: imageUrl }, caption: `Retrieved by daveie!\n${imageCaption}`}, { quoted: m });
    }

    if (quotedMessage.videoMessage) {
      let videoCaption = quotedMessage.videoMessage.caption;
      let videoUrl = await client.downloadAndSaveMediaMessage(quotedMessage.videoMessage);
      client.sendMessage(client.user.id, { video: { url: videoUrl }, caption: `Retrieved by daveie!\n${videoCaption}`}, { quoted: m });
    }
      }
	break;
...
//========================================================================================================================//		      
	case 'runtime':
		let raven = `𝙂𝙄𝙁𝙏𝙀𝘿-𝙈𝘿 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗿𝘂𝗻𝗻𝗶𝗻𝗴 𝘀𝗶𝗻𝗰𝗲 ${runtime(process.uptime())}`
                client.sendMessage(m.chat, {
                    text: raven,
                    contextInfo: {
                        externalAdReply: {
...
//========================================================================================================================//		      
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 𝐆𝐈𝐅𝐓𝐄𝐃-𝐌𝐃𝘁`}, { quoted: m }) 
...
//========================================================================================================================//		      
 case "gemini": {
    try {
        if (!text) return m.reply("This is dave-MD, an AI using Gemini APIs to process text, provide yr query");
...
//========================================================================================================================//		      
        ...
        if (!text) return reply(`Hello there, How can i help you?`);
          let d = await fetchJson(
            `https://bk9.fun/ai/davebox?q=${text}`
          );
          if (!d.BK9) {
            return reply(
              "An error occurred while fetching the AI chatbot response. Please try again later."
        ...
        default: {
          if (cmd && budy.toLowerCase() != undefined) {
            ...
            if (argsLog || (cmd && !m.isGroup)) {
              ...
              console.log(chalk.dave(chalk.bgRed("[ ERROR ]")), color("command", "turquoise"), color(`${prefix}${command}`, "turquoise"), color("Raven", "turquoise"));
